...
lat_dataframe = pd.DataFrame(index = lat_size, columns = ['Numba'], data = lat_time)
iter_dataframe = pd.DataFrame(index = iter_size, columns = ['Numba'], data = iter_time)

lat_dataframe.to_csv('./times/lat_numba.csv')
iter_dataframe.to_csv('./times/iter_numba.csv')